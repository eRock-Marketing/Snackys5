{block name='snippets-video'}
    {block name='snippets-video-title'}
        {if !empty($title)}
            <label>{$title}</label>
        {/if}
    {/block}
    {block name='snippets-video-content'}
        <div class="{if !empty($class)}{$class}{/if}
            ...
            {if $provider === 'youtube' || $provider === 'vimeo'}
                {block name='snippets-video-content-yt-vimeo'}
            ...
            {elseif $video->getType() === \JTL\Media\Video::TYPE_FILE}
                {block name='snippets-video-content-file'}
    ...
    {/block}
    {block name='snippets-video-additional'}
        {if $video->getType() === \JTL\Media\Video::TYPE_FILE}
            {block name='snippets-video-additional-controls'}
                ...
                {/if}
            {/block}
            {block name='snippets-video-additional-transcript'}
